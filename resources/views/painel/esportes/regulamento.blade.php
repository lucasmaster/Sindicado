                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="center-margin" align="center">
                                    ...
                                    <a href="{!! url('admin/deletar_regulamento/'.$dados->id) !!}" class="" title="Deletar Cadastro" data-toggle="tooltip" data-placement="top"><i class="glyphicon glyphicon-trash"></i></a>
                                </td>
