        ...
        <div class="row"> <!--form action -->
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form action="{{ url('/admin/editar_sindicato/'.$sindicato->id)}}" method="post"  enctype="multipart/form-data">
                            {!! csrf_field() !!}
                            <input name="data" type="hidden" class="form-control" id="create_data" value="<?= date('d/m/Y') ?>">
                            <div class="form-group">
                                <div class="form-group col-md-12">
                                    <textarea class="form-control" required name="descricao" id="summary-ckeditor">{!! old('content',$sindicato->descricao) !!}</textarea>
                                </div>
                            </div>
