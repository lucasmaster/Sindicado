    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Você está em asdfasdfasdf<small>{{$titulo or 'pags'}}</small></h3>
            </div>
        ...
        <div class="row"> <!--form action -->
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Cadastramento de <small>{{$titulo or 'Assessoria Juridica'}}</small></h2>
                        ...
                        <form action="sindicato" method="POST" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                            <div class="form-group">
                                <div class="form-group col-md-12">
                                                        <textarea id="summary-ckeditor" name="juridico" class="form-control"></textarea>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="center-margin" align="center">
                                    ...
                                    <a href="" class="" title="Ativar" data-toggle="tooltip" data-placement="top"><i class="fa fa-1x fa-fw fa-star"></i></a>
