    ...
    <div class="">
        ...
        <div class="row"> <!--form action -->
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Cadastramento de <small>{{$titulo or 'Agenda Cultural'}}</small></h2>
                    ...
                    <div class="x_content">
                        <form action="sindicato" method="POST" enctype="multipart/form-data" id="demo-form" data-parsley-validate class="form-horizontal form-label-left">
                            <!--div class="x_content">
                            ...
                            <div class="form-group"> 
                                ...
                                <div class='col-sm-9'>
                                    ...
                                    <textarea id="a_descricao" required="required" class="form-control" name="a_descricao" data-parsley-trigger="keyup" data-parsley-minlength="20" data-parsley-maxlength="100" data-parsley-validation-threshold="10"></textarea> <br/>
                                </div>
                                <div class="form-group">
                                    <div class='col-sm-4'>
                                        <label for="data"> Data e Horas *:</label>
                                        <div class='input-group date' id='myDatepicker2'>
                                            <input type='text' class="form-control" id="data" name="a_create" />
                                    ...
                                    <div class='col-sm-5'>
                                        ...
                                        <input type="text" id="a_local" class="form-control" name="a_local" required />
                                    </div>
                                    ...
                                    <div class='col-sm-12'>
                                        ...
                                        <p style="padding: 5px;">
                                            <input type="radio" name="a_destaque" id="hobby1" value="Sim" data-parsley-mincheck="2" required class="flat" /> Sim
                                            <br />

                                            <input type="radio" name="a_destaque" id="hobby2" value="Nao" class="flat" /> Não
                                            <br />
                                        </p>
                                    </div>
                                </div>
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td align="center">Descrição do Evento</td>
                                <td align="center">Data do Evento</td>
                                <td align="center">Local do Evento</td>
