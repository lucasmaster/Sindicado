    ...
    <div class="">
        ...
        <div class="row"> <!--form action -->
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Cadastramento de <small>{{$titulo or 'Acordos e Convocações'}}</small></h2>
                    ...
                    <div class="x_content">
                        <form action="sindicato" method="POST" enctype="multipart/form-data" id="demo-form" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="form-group"> 
                                <div class='col-sm-9'>
                                    <label for="a_nome">Nome do Documento* :</label>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label for="n_imagem">Upload do Arquivo :</label>
                                        <input type="file" id="imagem" name="n_arquivo">
                                    </div>
